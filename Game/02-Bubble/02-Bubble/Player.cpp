...
enum PlayerAnims
{
	STAND_LEFT, STAND_RIGHT, MOVE_LEFT, MOVE_RIGHT, JUMP_RIGHT, FALL_RIGHT, JUMP_LEFT, FALL_LEFT
};
...
void Player::init(const glm::ivec2 &tileMapPos, ShaderProgram &shaderProgram)
{
	...
	sprite->setNumberAnimations(8);
		...
		sprite->addKeyframe(FALL_RIGHT, glm::vec2(0.125*7.f, 0.f));

		sprite->setAnimationSpeed(JUMP_LEFT, 8);
		sprite->addKeyframe(JUMP_LEFT, glm::vec2(0.125*6.f, 0.5f));

		sprite->setAnimationSpeed(FALL_LEFT, 8);
		sprite->addKeyframe(FALL_LEFT, glm::vec2(0.125*7.f, 0.5f));
